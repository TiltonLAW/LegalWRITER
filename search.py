...
os.environ['CASELAW_API_KEY'] = 'insert-your-case.lew-api-here'
...
def generate_query(prompt):
    ...
    response = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f"Name one, and only one, fitting legal doctrine that addresses this question: \"{prompt}\"? If no legal doctrine fits, please reduce the question to the three most important words to get helpful results from a caselaw search engine. Do not answer in the narrative form, only provide the search terms in your reply and nothing else:"},
        ],
        temperature=0.8,
        max_tokens=10,
        top_p=1,
